...
1. **Map the system** — read CLAUDE.md, entry points, module boundaries
2. **Trace data flow** — follow a request from frontend through API to data sources
3. **Identify concerns** — coupling, missing abstractions, inconsistent patterns, bottlenecks
4. **Produce ADRs** — Architecture Decision Records for significant recommendations
